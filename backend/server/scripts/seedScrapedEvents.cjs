...
const realWeb3Events = [
  {
    ...
    description: 'The largest Web3 hackathon and conference bringing together builders, creators, and innovators from around the world.',
  ...
  },
  {
    ...
    description: 'CoinDesk\'s premier blockchain conference featuring industry leaders and cutting-edge technology.',
  ...
  },
  {
    ...
    location: 'Singapore',
    description: 'Premier crypto conference in Asia connecting global Web3 ecosystem.',
  ...
  },
  {
    ...
    description: 'Ethereum Foundation\'s flagship developer conference focusing on protocol development.',
  ...
  },
  {
    ...
    description: 'Ethereum Community Conference bringing together the European Web3 community.',
  ...
  },
  {
    ...
    description: 'Annual Solana conference showcasing the latest in high-performance blockchain technology.',
  ...
  },
  {
    ...
    description: 'Technical conference focused on Web3 infrastructure and decentralized technologies.',
...
async function seedScrapedEvents() {
  ...
  try {
    ...
    createdEvents.forEach(event => {
      const month = event.startTime.toLocaleDateString('en-US', { year: 'numeric', month: 'long' });
